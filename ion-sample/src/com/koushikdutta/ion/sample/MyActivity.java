...
public class MyActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tweetAdapter = new ArrayAdapter<JSONObject>(this, 0) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                // Use Ion's builder to now set the image on an ImageView from a URL
    ...
    // A Future is an object that manages the state of a "Future"
    // result from a long running operation.
